...
import com.sdl.selenium.web.test.PathBuilder;
 ...
 */
public abstract class WebLocatorAbstractBuilderDepricated {
    private static final Logger logger = Logger.getLogger(WebLocatorAbstractBuilderDepricated.class);
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setTag(final String tag) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setId(final String id) {
        this.id = id;
        return (T) this;
    }
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setElPath(final String elPath) {
        this.elPath = elPath;
        return (T) this;
    }
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setBaseCls(final String baseCls) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setCls(final String cls) {
        this.cls = cls;
        return (T) this;
    }
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setClasses(final String... classes) {
        if (classes != null) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setExcludeClasses(final String... excludeClasses) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setName(final String name) {
        this.name = name;
        return (T) this;
    }
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setText(final String text, final SearchType... searchType) {
        this.text = text;
        if (searchType != null) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setSearchTextType(SearchType... searchTextType) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setSearchLabelType(SearchType... searchLabelType) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setStyle(final String style) {
        this.style = style;
        return (T) this;
    }
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setElCssSelector(final String elCssSelector) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setTitle(String title) {
        this.title = title;
        return (T) this;
    }
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setElPathSuffix(String elPathSuffix) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setInfoMessage(final String infoMessage) {
    ...
    public <T extends WebLocatorAbstractBuilderDepricated> T setVisibility(final boolean visibility) {
    ...
    public <T extends WebLocatorAbstractBuilderDepricated> T setRenderMillis(final long renderMillis) {
        this.renderMillis = renderMillis;
        return (T) this;
    }

    public <T extends WebLocatorAbstractBuilderDepricated> T setRenderSeconds(final int renderSeconds) {
    ...
    public <T extends WebLocatorAbstractBuilderDepricated> T setActivateSeconds(final int activateSeconds) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setContainer(WebLocator container) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setLabel(String label, final SearchType... searchType) {
        this.label = label;
        if (searchType != null) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setLabelTag(String labelTag) {
     ...
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setLabelPosition(String labelPosition) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDepricated> T setPosition(int position) {
