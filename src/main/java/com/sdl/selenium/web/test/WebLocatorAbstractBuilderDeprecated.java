 ...
 */
public abstract class WebLocatorAbstractBuilderDeprecated {
    private static final Logger logger = Logger.getLogger(WebLocatorAbstractBuilderDeprecated.class);
     ...
     * @deprecated
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setTag(final String tag) {
        this.tag = tag;
        return (T) this;
    }
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setId(final String id) {
        this.id = id;
        return (T) this;
    }
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setElPath(final String elPath) {
        this.elPath = elPath;
        return (T) this;
    }
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setBaseCls(final String baseCls) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setCls(final String cls) {
        this.cls = cls;
        return (T) this;
    }
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setClasses(final String... classes) {
        if (classes != null) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setExcludeClasses(final String... excludeClasses) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setName(final String name) {
        this.name = name;
        return (T) this;
    }
     ...
     * <p><b><i>Used for finding element process (to generate xpath address)</i><b></p>
     *
     * @return value that has been set in {@link #setText(String, com.sdl.selenium.web.SearchType...)}
     */
     ...
     * @param searchType type search text element: see more details see {@link com.sdl.selenium.web.SearchType}
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setText(final String text, final SearchType... searchType) {
        this.text = text;
        if (searchType != null) {
     ...
     * <p><b>Used for finding element process (to generate xpath address)<b></p>
     *
     * @param searchTextType accepted values are: {@link com.sdl.selenium.web.SearchType#EQUALS}
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setSearchTextType(SearchType... searchTextType) {
     ...
     * <p><b>Used for finding element process (to generate xpath address)<b></p>
     *
     * @param searchLabelType accepted values are: {@link com.sdl.selenium.web.SearchType}
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setSearchLabelType(SearchType... searchLabelType) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setStyle(final String style) {
        this.style = style;
        return (T) this;
    }
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setElCssSelector(final String elCssSelector) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setTitle(String title) {
        this.title = title;
        return (T) this;
    }
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setElPathSuffix(String elPathSuffix) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setInfoMessage(final String infoMessage) {
    ...
    public <T extends WebLocatorAbstractBuilderDeprecated> T setVisibility(final boolean visibility) {
    ...
    public <T extends WebLocatorAbstractBuilderDeprecated> T setRenderMillis(final long renderMillis) {
        this.renderMillis = renderMillis;
        return (T) this;
    }

    public <T extends WebLocatorAbstractBuilderDeprecated> T setRenderSeconds(final int renderSeconds) {
    ...
    public <T extends WebLocatorAbstractBuilderDeprecated> T setActivateSeconds(final int activateSeconds) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setContainer(WebLocator container) {
     ...
     * <p><b><i>Used for finding element process (to generate xpath address)</i><b></p>
     *
     * @return value that has been set in {@link #setLabel(String, com.sdl.selenium.web.SearchType...)}
     */
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setLabel(String label, final SearchType... searchType) {
        this.label = label;
        if (searchType != null) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setLabelTag(String labelTag) {
     ...
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setLabelPosition(String labelPosition) {
     ...
     * @return this element
     */
    public <T extends WebLocatorAbstractBuilderDeprecated> T setPosition(int position) {
...
//        logger.debug(returnPath);
    ...
    protected String getLabelPath() {
        ...
        return new com.sdl.selenium.web.WebLocator().setText(getLabel(), st).setTag(getLabelTag()).getPath();
    }
}