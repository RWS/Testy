...
public class WebLocatorOld extends WebLocatorAbstractBuilder {
    private static final Logger LOGGER = LoggerFactory.getLogger(WebLocatorOld.class);
    ...
    public WebLocatorOld() {
    }

    /**
     * @param cls css class
     */
    public WebLocatorOld(String cls) {
        setClasses(cls);
    }

    public WebLocatorOld(WebLocatorOld container) {
//        setContainer(container);
    }

    public WebLocatorOld(String cls, WebLocatorOld container) {
        this(container);
        setClasses(cls);
    }

    public WebLocatorOld(String text, String cls, WebLocatorOld container) {
        this(cls, container);
        setText(text);
    }

    public WebLocatorOld(String tag, String baseCls) {
        setTag(tag);
        setBaseCls(baseCls);
    }
    ...
    public WebLocatorOld sendKeys(java.lang.CharSequence... charSequences) {
    ...
    public WebLocatorOld doSendKeys(java.lang.CharSequence... charSequences) {
    ...
    public boolean waitToActivate() {
        return waitToActivate(getXPathBuilder().getActivateSeconds());
    }
