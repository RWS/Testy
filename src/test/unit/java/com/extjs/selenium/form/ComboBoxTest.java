...
public class ComboBoxTest {
    ...
    public static Object[][] testConstructorPathDataProvider() {
        return new Object[][]{
                ...
                {new ComboBox("name", container),                      "//*[contains(@class, 'container')]//input[@name='name' and not(@type='hidden')]"},
                {new ComboBox(container, "ComboBoxCls", "name", true), "//*[contains(@class, 'container')]//input[@name='name' and contains(@class, 'ComboBoxCls') and not(@type='hidden')]"},
                {new ComboBox(container, "ComboBoxCls", "name", false),"//*[contains(@class, 'container')]//input[@name='name' and contains(@class, 'ComboBoxCls') and not(@type='hidden')]"}
        };
    }
