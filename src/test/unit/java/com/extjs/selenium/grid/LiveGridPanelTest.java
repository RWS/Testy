...
public class LiveGridPanelTest {
    ...
    private static String LIVE_GRID_PATH = "//*[contains(@class, 'ext-ux-livegrid') and not(starts-with(@id, 'ext-gen')) and not(contains(@class, 'x-panel-tc') or contains(@class, 'x-panel-tl') or contains(@class, 'x-panel-tr')) and not(contains(@class, 'x-hide-display')) and not(contains(@class, 'x-masked'))]";
    private static String LIVE_GRID_PANEL_CLS= "//*[contains(@class, 'ext-ux-livegrid') and contains(concat(' ', @class, ' '), ' GridPanelCls ') and not(starts-with(@id, 'ext-gen')) and not(contains(@class, 'x-panel-tc') or contains(@class, 'x-panel-tl') or contains(@class, 'x-panel-tr')) and not(contains(@class, 'x-hide-display')) and not(contains(@class, 'x-masked'))]";
