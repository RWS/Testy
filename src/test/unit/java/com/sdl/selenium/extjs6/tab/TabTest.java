...
public class TabTest {
    ...
    public static Object[][] testConstructorPathDataProvider() {
        return new Object[][]{
                ...
                {new Tab("/Title/Text", SearchType.CONTAINS_ANY), "//*[contains(concat(' ', @class, ' '), ' x-tab-bar ') and count(.//a[contains(concat(' ', @class, ' '), ' x-tab-active ')]//*[(contains(.,'Title') or contains(.,'Text'))]) > 0]//following-sibling::*[contains(concat(' ', @class, ' '), ' x-panel-body ')]/*[contains(concat(' ', @class, ' '), ' x-tabpanel-child ') and not(contains(@class, 'x-hidden-offsets'))]"},
