...
public class GroupTest {
    ...
    public static Object[][] testConstructorPathDataProvider() {
        return new Object[][]{
                ...
                {new Group(container, "Cuisine: Coffee", new Cell("Starbucks")),     "//*[contains(concat(' ', @class, ' '), ' x-grid ')]//table[count(.//td[contains(concat(' ', @class, ' '), ' x-group-hd-container ') and count(*//text()[contains(.,'Cuisine: Coffee')]) > 0]) > 0]/following-sibling::table[count(.//td[(contains(.,'Starbucks') or count(*//text()[contains(.,'Starbucks')]) > 0)]) > 0]"},
