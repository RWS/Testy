...
public class CheckBoxTest {
    ...
    public static Object[][] testConstructorPathDataProvider1() {
        return new Object[][]{
                {new @Version CheckBox().setVersion("6.7.0"), "//input[@type='checkbox']"},
                {new @Version CheckBox().setVersion("6.7.0").setClasses("CheckBoxClass"), "//input[contains(concat(' ', @class, ' '), ' CheckBoxClass ') and @type='checkbox']"},
                {new @Version CheckBox(container).setVersion("6.7.0"), "//*[contains(concat(' ', @class, ' '), ' container ')]//input[@type='checkbox']"},
                {new @Version CheckBox(container).setElPath("//table//tr[1]"), "//*[contains(concat(' ', @class, ' '), ' container ')]//table//tr[1]"},
                {new @Version CheckBox(container, "CheckBox").setVersion("6.7.0"), "//*[contains(concat(' ', @class, ' '), ' container ')]//label[(contains(.,'CheckBox') or count(*//text()[contains(.,'CheckBox')]) > 0)]//following-sibling::*//input[@type='checkbox']"},
                {new @Version CheckBox("BoxLabel", container).setVersion("6.7.0"), "//*[contains(concat(' ', @class, ' '), ' container ')]//label[text()='BoxLabel']/..//input[@type='checkbox']"},
        };
    }
