...
public class CheckBoxTest {
    ...
    public static Object[][] testConstructorPathDataProvider() {
        return new Object[][]{
                ...
                {new CheckBox(container).setElPath("//*[contains(., 'Register')]"), "//*[contains(concat(' ', @class, ' '), ' container ')]//*[contains(., 'Register')]"},
                {new CheckBox(container, "TextFieldText"),             "//*[contains(concat(' ', @class, ' '), ' container ')]//label[contains(.,'TextFieldText')]//input[@type='checkbox']"},
