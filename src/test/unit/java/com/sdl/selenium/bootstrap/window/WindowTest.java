...
public class WindowTest {
    ...
    public static Object[][] testConstructorPathDataProvider() {
        return new Object[][]{
                ...
                {new Window(By.id("ID")), "//*[@id='ID' and @role='dialog' and @aria-hidden='false']"},
                {new Window(By.title("WindowTitle")),"//*[count(*[contains(@class,'-header')]//*[text()='WindowTitle']) > 0 and @role='dialog' and @aria-hidden='false']"},
        };
    }
