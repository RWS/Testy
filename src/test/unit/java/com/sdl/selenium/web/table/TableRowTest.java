...
public class TableRowTest {
    ...
    public static WebLocator table = new SimpleTable().setId("ID");
    ...
    public static Object[][] testConstructorPathDataProvider() {
        return new Object[][]{
                ...
                {new TableRow(table, tableCell, new TableCell(4, "Eng-Fra", SearchType.EQUALS)), "//table[@id='ID']//tr[count(ancestor-or-self::*[contains(@style, 'display: none')]) = 0][count(th[3][text()='1234' or count(.//*[text()='1234']) > 0]) > 0 and count(td[4][text()='Eng-Fra' or count(.//*[text()='Eng-Fra']) > 0]) > 0]"},
                {new TableRow(table, new TableCell(), new TableCell()), "//table[@id='ID']//tr[count(ancestor-or-self::*[contains(@style, 'display: none')]) = 0][]"},
                {new TableRow(table, 1, new TableCell(), new TableCell()), "//table[@id='ID']//tr[count(ancestor-or-self::*[contains(@style, 'display: none')]) = 0][][position() = 1]"},
