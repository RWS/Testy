...
public class CellTest {
    ...
    public static Object[][] testConstructorPathDataProvider() {
        return new Object[][]{
                ...
                {new Cell("Header", "Cell", SearchType.EQUALS), "//td[count(//th[text()='Header']/preceding-sibling::*[@aria-hidden='false']) + number(boolean(//th[text()='Header']/preceding-sibling::*[@aria-hidden='false']))][(.='Cell' or count(*//text()[.='Cell']) > 0)]"},
        };
    }
