...
public class GridRowTest {
    ...
    public static Object[][] testConstructorPathDataProvider() {
        return new Object[][]{
                ...
                {new GridRow(grid, gridCell1).withVisibility(true), "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(.//td[1]//*[text()='CellText1']) > 0 and count(ancestor-or-self::*[contains(@style, 'display: none')]) = 0]"},
                {new GridRow(grid, 1, "SearchText", SearchType.CONTAINS), "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(.//td[1]//*[contains(text(),'SearchText')]) > 0]"},
