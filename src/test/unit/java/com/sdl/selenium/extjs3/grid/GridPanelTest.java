...
//                {grid.getGridCell("search", 2), GRID_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-0')]//*[contains(.,'search')]) > 0]//td[2]//*[contains(@class, 'x-grid3-cell-inner')]"},
//                {gridCls.getGridCell("search", 2), GRID_CLS_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-0')]//*[contains(.,'search')]) > 0]//td[2]//*[contains(@class, 'x-grid3-cell-inner')]"},
//                {gridContainer.getGridCell("search", 2), CONTAINER_PATH + GRID_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-0')]//*[contains(.,'search')]) > 0]//td[2]//*[contains(@class, 'x-grid3-cell-inner')]"},
//                {gridClsAndColumn.getGridCell("search", 2), GRID_CLS_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-1')]//*[contains(.,'search')]) > 0]//td[2]//*[contains(@class, 'x-grid3-cell-inner')]"},
//                {gridContainerAndColumn.getGridCell("search", 2), CONTAINER_PATH + GRID_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-1')]//*[contains(.,'search')]) > 0]//td[2]//*[contains(@class, 'x-grid3-cell-inner')]"},
//                {gridContainerAndClsAndColumn.getGridCell("search", 2), CONTAINER_PATH + GRID_CLS_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-1')]//*[contains(.,'search')]) > 0]//td[2]//*[contains(@class, 'x-grid3-cell-inner')]"},

                {grid.getGridCell("search", "2", 2), GRID_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-2')]//*[contains(.,'search')]) > 0]//td[2]//*[contains(@class, 'x-grid3-cell-inner')]"},
                {gridCls.getGridCell("search", "2", 2), GRID_CLS_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-2')]//*[contains(.,'search')]) > 0]//td[2]//*[contains(@class, 'x-grid3-cell-inner')]"},
                {gridContainer.getGridCell("search", "2", 2), CONTAINER_PATH + GRID_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-2')]//*[contains(.,'search')]) > 0]//td[2]//*[contains(@class, 'x-grid3-cell-inner')]"},
                {gridClsAndColumn.getGridCell("search", "2", 2), GRID_CLS_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-2')]//*[contains(.,'search')]) > 0]//td[2]//*[contains(@class, 'x-grid3-cell-inner')]"},
                {gridContainerAndColumn.getGridCell("search", "2", 2), CONTAINER_PATH + GRID_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-2')]//*[contains(.,'search')]) > 0]//td[2]//*[contains(@class, 'x-grid3-cell-inner')]"},
                {gridContainerAndClsAndColumn.getGridCell("search", "2", 2), CONTAINER_PATH + GRID_CLS_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-2')]//*[contains(.,'search')]) > 0]//td[2]//*[contains(@class, 'x-grid3-cell-inner')]"},

                {grid.getGridCell(1, 1, "text"), GRID_PATH + "//div[1][contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker'))]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and contains(.,'text')]"},
                {gridCls.getGridCell(1, 1, "text"), GRID_CLS_PATH + "//div[1][contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker'))]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and contains(.,'text')]"},
                {gridContainer.getGridCell(1, 1, "text"), CONTAINER_PATH + GRID_PATH + "//div[1][contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker'))]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and contains(.,'text')]"},
                {gridClsAndColumn.getGridCell(1, 1, "text"), GRID_CLS_PATH + "//div[1][contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker'))]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and contains(.,'text')]"},
                {gridContainerAndColumn.getGridCell(1, 1, "text"), CONTAINER_PATH + GRID_PATH + "//div[1][contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker'))]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and contains(.,'text')]"},
                {gridContainerAndClsAndColumn.getGridCell(1, 1, "text"), CONTAINER_PATH + GRID_CLS_PATH + "//div[1][contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker'))]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and contains(.,'text')]"},

                {grid.getGridCell("SearchText", 1, "text"), GRID_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-0')]//*[contains(.,'SearchText')]) > 0]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and contains(.,'text')]"},
                {gridCls.getGridCell("SearchText", 1, "text"), GRID_CLS_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-0')]//*[contains(.,'SearchText')]) > 0]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and contains(.,'text')]"},
                {gridContainer.getGridCell("SearchText", 1, "text"), CONTAINER_PATH + GRID_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-0')]//*[contains(.,'SearchText')]) > 0]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and contains(.,'text')]"},
                {gridClsAndColumn.getGridCell("SearchText", 1, "text"), GRID_CLS_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-1')]//*[contains(.,'SearchText')]) > 0]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and contains(.,'text')]"},
                {gridContainerAndColumn.getGridCell("SearchText", 1, "text"), CONTAINER_PATH + GRID_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-1')]//*[contains(.,'SearchText')]) > 0]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and contains(.,'text')]"},
                {gridContainerAndClsAndColumn.getGridCell("SearchText", 1, "text"), CONTAINER_PATH + GRID_CLS_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-1')]//*[contains(.,'SearchText')]) > 0]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and contains(.,'text')]"},

                {grid.getGridCell("SearchText", 1, "text", SearchType.EQUALS), GRID_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-0')]//*[contains(.,'SearchText')]) > 0]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and text()='text']"},
                {gridCls.getGridCell("SearchText", 1, "text", SearchType.EQUALS), GRID_CLS_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-0')]//*[contains(.,'SearchText')]) > 0]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and text()='text']"},
                {gridContainer.getGridCell("SearchText", 1, "text", SearchType.EQUALS), CONTAINER_PATH + GRID_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-0')]//*[contains(.,'SearchText')]) > 0]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and text()='text']"},
                {gridClsAndColumn.getGridCell("SearchText", 1, "text", SearchType.EQUALS), GRID_CLS_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-1')]//*[contains(.,'SearchText')]) > 0]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and text()='text']"},
                {gridContainerAndColumn.getGridCell("SearchText", 1, "text", SearchType.EQUALS), CONTAINER_PATH + GRID_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-1')]//*[contains(.,'SearchText')]) > 0]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and text()='text']"},
                {gridContainerAndClsAndColumn.getGridCell("SearchText", 1, "text", SearchType.EQUALS), CONTAINER_PATH + GRID_CLS_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-1')]//*[contains(.,'SearchText')]) > 0]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and text()='text']"},

                {gridContainerAndClsAndColumn.getGridCell("SearchText", 1, "/text/exe", SearchType.CONTAINS_ALL), CONTAINER_PATH + GRID_CLS_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-1')]//*[contains(.,'SearchText')]) > 0]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and contains(.,'text') and contains(.,'exe')]"},
                {gridContainerAndClsAndColumn.getGridCell("SearchText", 1, "|text|exe", SearchType.CONTAINS_ANY), CONTAINER_PATH + GRID_CLS_PATH + "//*[count(*[contains(@class, 'x-grid3-row-table')]//*[contains(@class, 'x-grid3-td-1')]//*[contains(.,'SearchText')]) > 0]//td[1]//*[contains(concat(' ', @class, ' '), ' x-grid3-cell-inner ') and (contains(.,'text') or contains(.,'exe'))]"},
