...
public class GridPanelTest {
    ...
    public static Object[][] testConstructorPathDataProvider1() {
        return new Object[][]{
                ...
                {gridContainer.getRowLocator(1), CONTAINER_PATH + GRID_PATH + "//div[1][contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker'))]"},
                ...
                {gridContainerAndClsAndColumn.getRowLocator(1), CONTAINER_PATH + GRID_CLS_PATH + "//div[1][contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker'))]"}
        };
    }
    ...
    public static Object[][] testConstructorPathDataProvider2() {
        return new Object[][]{
                ...
                {gridContainer.getCell("search", SearchType.EQUALS), CONTAINER_PATH + GRID_PATH + "//*[contains(@class, 'x-grid3-td-0')]//*[text()='search']"},
                ...
                {gridContainerAndClsAndColumn.getCell("search", SearchType.EQUALS), CONTAINER_PATH + GRID_CLS_PATH + "//*[contains(@class, 'x-grid3-td-1')]//*[text()='search']"},
                ...
                {gridContainer.getCell("search", SearchType.STARTS_WITH), CONTAINER_PATH + GRID_PATH + "//*[contains(@class, 'x-grid3-td-0')]//*[starts-with(text(),'search')]"},
                ...
                {gridContainerAndClsAndColumn.getCell("search", SearchType.STARTS_WITH), CONTAINER_PATH + GRID_CLS_PATH + "//*[contains(@class, 'x-grid3-td-1')]//*[starts-with(text(),'search')]"},
                ...
                {grid.getGridCell(1, new GridCell(1, "text", SearchType.EQUALS)), GRID_PATH + "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(.//td[1]//*[text()='text']) > 0]//td[1]//*"},
                {gridCls.getGridCell(1, new GridCell(1, "text", SearchType.EQUALS)), GRID_CLS_PATH + "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(.//td[1]//*[text()='text']) > 0]//td[1]//*"},
                {gridContainer.getGridCell(1, new GridCell(1, "text", SearchType.EQUALS)), CONTAINER_PATH + GRID_PATH + "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(.//td[1]//*[text()='text']) > 0]//td[1]//*"},
                {gridClsAndColumn.getGridCell(1, new GridCell(1, "text", SearchType.EQUALS)), GRID_CLS_PATH + "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(.//td[1]//*[text()='text']) > 0]//td[1]//*"},
                {gridContainerAndColumn.getGridCell(1, new GridCell(1, "text", SearchType.EQUALS)), CONTAINER_PATH + GRID_PATH + "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(.//td[1]//*[text()='text']) > 0]//td[1]//*"},
                {gridContainerAndClsAndColumn.getGridCell(1, new GridCell(1, "text", SearchType.EQUALS)), CONTAINER_PATH + GRID_CLS_PATH + "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(.//td[1]//*[text()='text']) > 0]//td[1]//*"},

                {gridContainerAndClsAndColumn.getGridCell(1, new GridCell(1, "/text/exe", SearchType.CONTAINS_ALL)), CONTAINER_PATH + GRID_CLS_PATH + "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(.//td[1]//*[contains(text(),'text') and contains(text(),'exe')]) > 0]//td[1]//*"},
                {gridContainerAndClsAndColumn.getGridCell(1, new GridCell(1, "|text|exe", SearchType.CONTAINS_ANY)), CONTAINER_PATH + GRID_CLS_PATH + "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(.//td[1]//*[(contains(text(),'text') or contains(text(),'exe'))]) > 0]//td[1]//*"},
