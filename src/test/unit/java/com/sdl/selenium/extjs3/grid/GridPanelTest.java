...
public class GridPanelTest {
    ...
    public static Object[][] testConstructorPathDataProvider2() {
        return new Object[][]{
                ...
                {gridContainerAndClsAndColumn.getCell(1, new GridCell(1, "/text/exe", SearchType.CONTAINS_ALL)), CONTAINER_PATH + GRID_CLS_PATH + "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(.//td[1]//*[contains(text(),'text') and contains(text(),'exe')]) > 0]//td[1]//*"},
                {gridContainerAndClsAndColumn.getCell(1, new GridCell(1, "|text|exe", SearchType.CONTAINS_ANY)), CONTAINER_PATH + GRID_CLS_PATH + "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(.//td[1]//*[(contains(text(),'text') or contains(text(),'exe'))]) > 0]//td[1]//*"},
