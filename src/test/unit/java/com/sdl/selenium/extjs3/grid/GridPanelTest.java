...
public class GridPanelTest {
    ...
    public static Object[][] testConstructorPathDataProvider2() {
        return new Object[][]{
                ...
                {grid.getGridCell(1, new GridCell(1, "text", SearchType.EQUALS)), GRID_PATH + "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(*[contains(@class, 'x-grid3-row-table')]//td[1]//*[text()='text']) > 0]//td[1]//*"},
                {gridCls.getGridCell(1, new GridCell(1, "text", SearchType.EQUALS)), GRID_CLS_PATH + "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(*[contains(@class, 'x-grid3-row-table')]//td[1]//*[text()='text']) > 0]//td[1]//*"},
                {gridContainer.getGridCell(1, new GridCell(1, "text", SearchType.EQUALS)), CONTAINER_PATH + GRID_PATH + "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(*[contains(@class, 'x-grid3-row-table')]//td[1]//*[text()='text']) > 0]//td[1]//*"},
                {gridClsAndColumn.getGridCell(1, new GridCell(1, "text", SearchType.EQUALS)), GRID_CLS_PATH + "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(*[contains(@class, 'x-grid3-row-table')]//td[1]//*[text()='text']) > 0]//td[1]//*"},
                {gridContainerAndColumn.getGridCell(1, new GridCell(1, "text", SearchType.EQUALS)), CONTAINER_PATH + GRID_PATH + "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(*[contains(@class, 'x-grid3-row-table')]//td[1]//*[text()='text']) > 0]//td[1]//*"},
                {gridContainerAndClsAndColumn.getGridCell(1, new GridCell(1, "text", SearchType.EQUALS)), CONTAINER_PATH + GRID_CLS_PATH + "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(*[contains(@class, 'x-grid3-row-table')]//td[1]//*[text()='text']) > 0]//td[1]//*"},

                {gridContainerAndClsAndColumn.getGridCell(1, new GridCell(1, "/text/exe", SearchType.CONTAINS_ALL)), CONTAINER_PATH + GRID_CLS_PATH + "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(*[contains(@class, 'x-grid3-row-table')]//td[1]//*[contains(text(),'text') and contains(text(),'exe')]) > 0]//td[1]//*"},
                {gridContainerAndClsAndColumn.getGridCell(1, new GridCell(1, "|text|exe", SearchType.CONTAINS_ANY)), CONTAINER_PATH + GRID_CLS_PATH + "//*[contains(concat(' ', @class, ' '), ' x-grid3-row ') and not(contains(@class, 'x-grid3-row-checker')) and count(*[contains(@class, 'x-grid3-row-table')]//td[1]//*[(contains(text(),'text') or contains(text(),'exe'))]) > 0]//td[1]//*"},
