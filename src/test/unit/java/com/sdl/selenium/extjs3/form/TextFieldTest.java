...
public class TextFieldTest {
    ...
    public static Object[][] testConstructorPathDataProvider() {
        return new Object[][]{
                ...
                {new TextField(By.id("ID")),                           "//input[@id='ID' and not(@type='hidden')]"},
                {new TextField(By.classes("TextFieldClass")),                       "//input[contains(concat(' ', @class, ' '), ' TextFieldClass ') and not(@type='hidden')]"},
                {new TextField(By.container(container)),                              "//*[contains(concat(' ', @class, ' '), ' container ')]//input[not(@type='hidden')]"},
                ...
                {new TextField(By.container(container), By.label("TextFieldText")),             "//*[contains(concat(' ', @class, ' '), ' container ')]//label[text()='TextFieldText']//following-sibling::*//input[not(@type='hidden')]"},
                {new TextField(By.container(container), By.name("name")),                      "//*[contains(concat(' ', @class, ' '), ' container ')]//input[@name='name' and not(@type='hidden')]"},
        };
    }
