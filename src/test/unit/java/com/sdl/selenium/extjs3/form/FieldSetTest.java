...
public class FieldSetTest {
    ...
    public static Object[][] testConstructorPathDataProvider() {
        return new Object[][]{
                ...
                {new FieldSet(container).withText("FieldSetText"),                "//*[contains(concat(' ', @class, ' '), ' container ')]//fieldset[contains(concat(' ', @class, ' '), ' x-fieldset ') and not(contains(@class, 'x-hide-display')) and not(contains(@class, 'x-masked')) and count(.//*[normalize-space(text())='FieldSetText']) > 0]"},
