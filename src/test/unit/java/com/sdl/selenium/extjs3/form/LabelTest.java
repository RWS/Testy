...
public class LabelTest {
    ...
    public static Object[][] testConstructorPathDataProvider() {
        return new Object[][]{
                {new Label("LabelText"), "//label[contains(.,'LabelText')]"},
                {new Label(container), "//*[contains(concat(' ', @class, ' '), ' container ')]//label"},
                {new Label(container).setLabel("Label", SearchType.CONTAINS), "//*[contains(concat(' ', @class, ' '), ' container ')]//label[contains(.,'Label')]//following-sibling::*//label"},
                ...
                {new Label(container, "LabelText"), "//*[contains(concat(' ', @class, ' '), ' container ')]//label[contains(.,'LabelText')]"},
        };
    }
