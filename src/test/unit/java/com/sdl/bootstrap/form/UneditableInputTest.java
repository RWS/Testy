...
public class UneditableInputTest {
    ...
    public static Object[][] testConstructorPathDataProvider() {
        return new Object[][]{
                ...
                {new UneditableInput(container),                              "//*[contains(concat(' ', @class, ' '), ' container ')]//span[contains(@class, 'uneditable-input')]"},
                {new UneditableInput(container).setElPath("//*[contains(text(), 'Register')]"), "//*[contains(concat(' ', @class, ' '), ' container ')]//*[contains(text(), 'Register')]"},
                {new UneditableInput(container, "TextFieldText"),             "//*[contains(concat(' ', @class, ' '), ' container ')]//label[text()='TextFieldText']//following-sibling::*//span[contains(@class, 'uneditable-input')]"},
        };
    }
