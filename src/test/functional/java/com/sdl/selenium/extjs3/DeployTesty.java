...
public class DeployTesty extends TestBase {
    ...
    private static final String DOMAIN_PASS = "VCinit*08";
    ...
    private WebLocator testyDir = new WebLocator().setElxPath("//a[@class='x-tree-node-anchor' and count(.//span[text()='Testy']) > 0]");
